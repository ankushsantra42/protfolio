...
import { RiArrowDownLongLine, RiArrowRightLine, RiArrowRightLongFill, RiArrowRightLongLine, RiChat4Line, RiMailLine, RiMenuLine, RiUserLine,  } from "@remixicon/react"
        ...
        <nav className='w-full sticky top-0 z-50 flex items-center justify-between px-10 py-4 max-w-7xl mx-auto bg-[var(--page-bg)] transition-colors duration-300'>
          ...
          <div className='hidden md:block'>
            <ul className='flex gap-10'>
              <li  className='hover:scale-120 transition duration-200 ease-in'><a name="home" onClick={scrollToPage} href="#home">Home</a></li>
              <li className='hover:scale-120 transition duration-200 ease-in'><a name="project" onClick={scrollToPage} href="#project">Projects</a></li>
              <li className='hover:scale-120 transition duration-200 ease-in'><a name="contact" onClick={scrollToPage} href="#contact">Contact</a></li>
            </ul>
          </div>
